...
public class BottomLeftMenu extends ScrollView implements OnClickListener {
    ...
    private OpenCloseAnimation mOpenCloseAnimation;
    ...
    private void initAttrs(TypedArray a) {
        ...
        mTextColorRes = a.getColor(R.styleable.BottomLeftMenu_blm_itemTextColor, Color.BLACK);
        mTextSize = a.getDimension(R.styleable.BottomLeftMenu_blm_itemTextSize, r.getDimension(R.dimen.default_item_text_size));
        mPressedStateColor = a.getColor(R.styleable.BottomLeftMenu_blm_itemPressedStateColor, r.getColor(R.color.default_item_pressed_state_color));
        mNormalStateColor = a.getColor(R.styleable.BottomLeftMenu_blm_itemNormalStateColor, r.getColor(android.R.color.transparent));
        mShowDivider = a.getBoolean(R.styleable.BottomLeftMenu_blm_showDivider, true);
        mDividerHeight = (int) a.getDimension(R.styleable.BottomLeftMenu_blm_dividerHeight, r.getDimension(R.dimen.default_divider_height));
        mDividerColor = a.getColor(R.styleable.BottomLeftMenu_blm_dividerColor, r.getColor(R.color.default_divider_color));
        mOpenCloseAnimationType = OPEN_CLOSE_ANIMATION.values()[a.getInt(R.styleable.BottomLeftMenu_blm_openCloseAnimation, 0)];
    ...
    private void init(Context context) {
        ...
        setOpenCloseAnimation(OpenCloseAnimationFactory.getAnimation(context, mOpenCloseAnimationType));
     ...
     *
     * @param openCloseAnimation - a OpenCloseAnimation implementation.
     */
    public void setOpenCloseAnimation(OpenCloseAnimation openCloseAnimation) {
    ...
    public void setOnBottomLeftMenuItemClickListener(OnBottomLeftMenuItemClickListener itemClickListener) {
        mOnBottomLeftMenuItemClickListener = itemClickListener;
    }

    private void addMenuItem(BottomLeftMenuItem menuItem) {
        setSelector(menuItem);
        menuItem.getTextView().setTextColor(mTextColorRes);
        menuItem.getTextView().setTextSize(mTextSize);
        menuItem.setOnClickListener(this);

        mViewsContainer.addView(menuItem);
    }

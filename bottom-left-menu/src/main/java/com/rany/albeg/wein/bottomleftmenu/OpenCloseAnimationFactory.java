...
public class OpenCloseAnimationFactory {

	public static OpenCloseAnimation getAnimation(Context context, OPEN_CLOSE_ANIMATION animType) {
		OpenCloseAnimation animation = null;
